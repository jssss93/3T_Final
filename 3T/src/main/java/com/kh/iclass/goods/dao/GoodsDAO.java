...
public class GoodsDAO extends AbstractDAO {
	 ...
	 * selectGoodsDetail(Map<String, Object> map) throws Exception{ return
	 * (Map<String, Object>) selectOne("goods.selectDetail", map); }
	 * 
	 ...
	 * (List<Map<String, Object>>)selectList("goods.selectFileList", map); } public
	 ...
	 * selectRelatedList(List<Object> list) { // TODO Auto-generated method stub
