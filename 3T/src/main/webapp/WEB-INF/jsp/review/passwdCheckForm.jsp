			...
			<tr>
				...
				<td width="150" >
					...
					&nbsp;&nbsp; <input type="submit" value="확인" >
						<input type="hidden" id="REVIEW_NO" name="REVIEW_NO" value="${list.REVIEW_NO }">
					    <input type="hidden" id="REVIEW_COMMENT_NO" name="REVIEW_COMMENT_NO" value="${list.REVIEW_COMMENT_NO }">
