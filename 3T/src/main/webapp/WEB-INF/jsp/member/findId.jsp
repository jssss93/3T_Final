   ...
   <div id="contentwrap">
      ...
      <div id="contents">
         ...
         <form id="member_form_6149332581" name=""
            action="/3T/findPasswdForm" method="post" onsubmit="return validation();">
    ...
    -->
               <div class="login">
                  ...
                  <fieldset>
                     ...
                     <span>아이디</span> <label class="id">찾으신아이디는 ${MEMBER_ID}</label>
                     
				
				     <p class="link">
                        
                        <span class="loginbtn"><input class="loginbtn" type="submit" value="비밀번호찾기 "></span>
