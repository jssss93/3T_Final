			...
			<tr>
				<td align="center" style="padding: 50px;">
					<table width="700" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td height="40" align="center" class="text01 formbar" colspan="2">정보수정</td>
						</tr>
						<tr>
							<td height="60"></td>
						</tr>
					...
					<table width="700" border="0" cellspacing="0" cellpadding="0"
						...
						<tr>
							...
							<input type="password" maxlength="14"
								name="PASSWD" size="30" value="${row.PASSWD}"> 영문/숫자를 이용하여 4~12자로 입력하세요</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td valign="middle"><input type="text" name="NAME"
								size="28" value="${row.NAME}" disabled> 회원가입 후 수정이 불가능합니다</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td valign="middle"><input type="text" id="ZIPCODE"
								name="ZIPCODE" size="28" placeholder="검색버튼이용해주세요" value="${row.ZIPCODE}">
						...
						<tr>
							...
							<td valign="middle"><input type="text" id="ADDR1"
								name="ADDR1" placeholder="자동기입" size="60" value="${row.ADDR1}"> <br>
								<input type="text" id="ADDR2" name="ADDR2" placeholder="상제주소를 입력해주세요"size="60" value="${row.ADDR2}"></td>
						</tr>
						...
						<tr>
							...
							<td valign="middle"><input type="text" name="PHONE" maxlength="11"
								size="28" placeholder="ex)01055551111" value="${row.PHONE}"> "-" 없이 숫자만 입력하세요</td>
						</tr>
						...
						<tr>
							<td colspan="2" align="center" style="border: 0px;"><input
								type="submit" value="수정완료" class="submit"> <input
