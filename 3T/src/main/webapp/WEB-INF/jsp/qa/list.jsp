...
<body>
	<table width="100%" align="center" border="0" cellspacing="1" cellpadding="1" class="board_top">
		<tr>
			<td height="50"></td>
		</tr>
		<tr>
			<td align="left" class="text01 formbar"><h6><font color="#000000">QA</font></h6></td>
		</tr>
	...
	<table width="100%" align="center" border="0" cellspacing="0" cellpadding="2" class="board_review3">
               <tr>
	...
	<tr>
	<td>
		<select class="btn" name="SearchNum" id="SearchNum" style="width: 100px; height: 30px;" >
					<option value="MEMBER_ID">NAME</option>
					<option value="TITLE">TITLE</option>
					<option value="CONTENT">CONTENT</option>
				</select>
				
				<input type="text" class="btn" name="SearchKeyword" id="SearchKeyword" style="margin-left:15px;width:200px;height:36px;border-radius :5px 5px 5px 5px;"/>            
